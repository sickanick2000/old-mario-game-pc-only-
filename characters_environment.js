...
{
 GameStatus = "start";
 document.getElementById("status").innerHTML = "your game is loading btw thats sad my pc is too good for lag"
}
...
function game(){
  ...
  if(gameConfig.status==='start'){
    ...
    textSize(40);
    textAlign(CENTER);
    text("Press the play button above this to Start and Play ", gameConfig.screenX/2, gameConfig.screenY/2);
    textSize(40);
